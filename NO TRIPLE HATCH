...
V2FORSLOWINTERNET.Name = "ANTI AFK"
...
V2FORSLOWINTERNET.Text = "ANTI AFK AND REMOVE EGG ANIMATION"
...
FORFASTINTERNET.Text = "AUTO BUY EGGG  AND REMOVE EGG ANIMATION"
...
Event:InvokeServer(A_1)-- Script generated by R2Sv2
